...
const LINE = [
  {
    ...
    alt: "Opening Line, a white airless pump wrapped in cream and Founder Green stripes.",
  ...
  },
  {
    ...
    alt: "Clean Break, a white pump bottle wrapped in cream and Founder Green stripes.",
  ...
  },
  {
    ...
    alt: "Hold the Room beside its Founder Green carton, the bottle wrapped in desert rose and green stripes.",
  ...
  },
  {
    ...
    alt: "Double Take beside its Founder Green carton, the bottle wrapped in desert rose and green stripes.",
  ...
  },
  {
    ...
    alt: "Smooth Talker in 25 Medium beside its Founder Green carton, the stick wrapped in tan stripes matching the shade.",
