...
const LINE = [
  {
    ...
    image: "/products/opening-line-vanity-tall.webp",
    alt: "Opening Line and its carton in rose and green stripes on a cream marble vanity, an emerald door open onto a blush dressing room beyond.",
