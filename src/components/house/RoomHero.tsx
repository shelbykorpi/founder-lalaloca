    ...
    >
      ...
      <div className="shell relative flex w-full flex-1 items-end pb-14 pt-28 md:items-center md:py-24">
        <div className="max-w-[32rem]">
          ...
          <Heading className="headline-house mt-5 text-balance text-cream">{title}</Heading>
          {lede && (
          ...
          {children && (
            <div className="mt-8 flex flex-wrap items-center gap-x-8 gap-y-4">{children}</div>
          )}
        </div>
      </div>
    </section>
